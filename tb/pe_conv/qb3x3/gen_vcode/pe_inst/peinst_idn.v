...
//---- kernel ----//
    ...
    .ker_7( ker_shf[0][ 7-:8] ) , 
//---- bias ----//
    .bias_in	( bi_con_0_dly0 ), 
    .bias_offset( bi_offset_0_dly0 ), 
.valid_out ( q_valid[0] ) ,
.outmacb_sum ( row_sumshf[0] ) ,
...
//---- kernel ----//
    ...
    .ker_7( ker_shf[1][ 7-:8] ) , 
//---- bias ----//
    .bias_in	( bi_con_1_dly0 ), 
    .bias_offset( bi_offset_1_dly0 ), 
.valid_out ( q_valid[1] ) ,
.outmacb_sum ( row_sumshf[1] ) ,
...
//---- kernel ----//
    ...
    .ker_7( ker_shf[2][ 7-:8] ) , 
//---- bias ----//
    .bias_in	( bi_con_2_dly0 ), 
    .bias_offset( bi_offset_2_dly0 ), 
.valid_out ( q_valid[2] ) ,
.outmacb_sum ( row_sumshf[2] ) ,
...
//---- kernel ----//
    ...
    .ker_7( ker_shf[3][ 7-:8] ) , 
//---- bias ----//
    .bias_in	( bi_con_3_dly0 ), 
    .bias_offset( bi_offset_3_dly0 ), 
.valid_out ( q_valid[3] ) ,
.outmacb_sum ( row_sumshf[3] ) ,
...
//---- kernel ----//
    ...
    .ker_7( ker_shf[4][ 7-:8] ) , 
//---- bias ----//
    .bias_in	( bi_con_4_dly0 ), 
    .bias_offset( bi_offset_4_dly0 ), 
.valid_out ( q_valid[4] ) ,
.outmacb_sum ( row_sumshf[4] ) ,
...
//---- kernel ----//
    ...
    .ker_7( ker_shf[5][ 7-:8] ) , 
//---- bias ----//
    .bias_in	( bi_con_5_dly0 ), 
    .bias_offset( bi_offset_5_dly0 ), 
.valid_out ( q_valid[5] ) ,
.outmacb_sum ( row_sumshf[5] ) ,
...
//---- kernel ----//
    ...
    .ker_7( ker_shf[6][ 7-:8] ) , 
//---- bias ----//
    .bias_in	( bi_con_6_dly0 ), 
    .bias_offset( bi_offset_6_dly0 ), 
.valid_out ( q_valid[6] ) ,
.outmacb_sum ( row_sumshf[6] ) ,
...
//---- kernel ----//
    ...
    .ker_7( ker_shf[7][ 7-:8] ) , 
//---- bias ----//
    .bias_in	( bi_con_7_dly0 ), 
    .bias_offset( bi_offset_7_dly0 ), 
.valid_out ( q_valid[7] ) ,
.outmacb_sum ( row_sumshf[7] ) ,
